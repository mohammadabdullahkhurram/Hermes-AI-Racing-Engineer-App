  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg }}>
      <div ref={heroRef} onMouseMove={handleMouseMove} style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", overflow: "hidden", paddingTop: 60 }}>
        ...
        <div style={{ position: "absolute", inset: 0, background: `radial-gradient(circle 280px at ${mousePos.x}% ${mousePos.y}%, rgba(15,248,192,0.06) 0%, transparent 70%)`, pointerEvents: "none", transition: "background 0.3s ease" }} />
